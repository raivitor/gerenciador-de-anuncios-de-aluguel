...
export class F1Crawler extends BaseCrawler {
  baseURL =
    'https://f1ciaimobiliaria.com.br/imoveis-para-alugar/?jsf=jet-engine:pesquisa&tax=tipo-de-imovel:8;cidade:61,92,71,34,36,74,63,47,45&meta=area!range:70_1000;valor-do-aluguel!range:1000_4000&sort=orderby:meta_value_num;order:ASC;meta_key:valor-do-aluguel';
